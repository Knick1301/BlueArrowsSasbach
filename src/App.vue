  ...
  <div class="min-h-screen flex flex-col font-sans bg-gray-100">
        ...
        <nav class="flex items-center bg-transparent rounded-full px-2 py-1 overflow-visible">
          <router-link to="/" @click="closeMenu"
            ...
            <img :src="basLogo"
              ...
              :class="['-top-10 w-28', 'lg:-top-10 lg:w-45']" alt="BAS Logo" />
          </router-link>
    ...
    <footer class="bg-[#032650] relative flex justify-center items-center h-24 mt-auto px-6">
      <a href="https://www.facebook.com/bluearrows.de" target="_blank" rel="noopener noreferrer"
        class="absolute left-6 hover:scale-110 transition-transform md:hidden block" aria-label="Facebook">
      ...
      <a href="https://www.facebook.com/bluearrows.de" target="_blank" rel="noopener noreferrer"
        class="absolute right-24 hover:scale-110 transition-transform hidden md:block" aria-label="Facebook">
        <img :src="facebookLogo" class="w-13 h-13 object-contain" alt="Facebook" />
      </a>
      <a href="https://www.instagram.com/bluearrows.de/" target="_blank" rel="noopener noreferrer"
        class="absolute right-6 hover:scale-110 transition-transform" aria-label="Instagram">
