...
<template v-if="story && story.content">
  ...
  <div class="bg-[#f2eded] p-6 pt-0 flex-grow flex flex-col">
    <div class="grid grid-cols-1 sm:gap-10 lg:grid-cols-12 lg:gap-20 items-stretch">
      <div class="lg:col-span-4 col-span-1 flex flex-col h-full">
        <h2
          class="font-bold text-[#032650] border-b-4 border-[#032650] inline-block mb-8 mt-4 text-2xl self-start"
        >
          <router-link to="/teams">Unsere Teams</router-link>
        </h2>
        ...
        >
          ...
          >
            <img
              ...
              class="aspect-video lg:h-[80%] w-full object-cover"
              alt="Team Image"
            />
            <div
      ...
      <div class="lg:col-span-3 col-span-1 flex flex-col lg:pl-4 h-full">
        <h2
          class="font-bold text-[#032650] border-b-4 border-[#032650] inline-block mb-8 mx-8 mt-4 text-2xl self-start"
        >
          <router-link to="/news">Aktuelle News</router-link>
        </h2>
      ...
      <div class="lg:col-span-5 col-span-1 flex flex-col lg:pl-6 h-full">
        <div class="px-8">
          <h2
