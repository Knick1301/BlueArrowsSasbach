        ...
        <div class="max-w-[1400px] w-[95%] mx-auto mt-15 px-4 flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
            ...
            <div
                ...
                <p
                    ...
                    jeder Menge Spaß auf Rollen. Egal ob Anfänger oder alter Hase, für Jung und Alt ist bei
                    unserer Inline Disco etwas dabei.
                </p>
                ...
                <div
                    ...
                    <div class="md:pr-8">
                        ...
                        <p class="text-gray-600 font-semibold mb-4">
                            Musik, Licht & gute Laune
                        </p>
                        <p class="mb-5 md:mb-10 text-base font-medium text-gray-700 leading-relaxed">
                            DJ, Discolicht und eine geräumige Fläche zum Skaten und Tanzen – bei uns kommt
                            echtes Rollschuhdisco-Feeling auf.
                        </p>
                        <ul
                    ...
                    <div class="mt-6 md:mt-0 md:pl-8 flex flex-col h-full">
                        ...
                        <p class="mb-5 text-base font-medium text-gray-700 leading-relaxed">
                            Inliner und Schutzausrüstung können bei uns vor Ort ausgeliehen werden. Eigene
                            Inliner sind natürlich auch jederzeit willkommen.
                        </p>
                        <div
