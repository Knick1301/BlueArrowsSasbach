...
<template>
  <div class="mb-15">
    ...
    <div class="max-w-[1400px] mx-auto mt-10 px-4 flex flex-col xl:flex-row gap-10 xl:gap-20 items-start">
      <div
        class="w-full xl:w-1/2 bg-white rounded-xl shadow-[0_2px_20px_rgba(0,0,0,0.1)] border-t-[5px] border-[#032650] p-6 md:p-10 text-gray-800 flex flex-col h-full">
        ...
        <h3 class="text-[#032650] text-xl font-bold border-b-[3px] border-[#032650] w-fit pb-1 mb-4 mt-2">
          Unsere Einteilung
        </h3>
        <div class="mb-8 space-y-4">
          <div class="bg-blue-50 p-4 rounded-xl border-l-[4px] border-[#032650]">
            <div class="text-[#032650] font-black text-xl uppercase tracking-wider mb-1">
              Anfänger
            </div>
        ...
        <h3 class="text-[#032650] text-xl font-bold border-b-[3px] border-[#032650] w-fit pb-1 mb-4">
          Eckdaten & Kosten
        </h3>
        <div class="mb-8 space-y-4">
          <div class="bg-gray-50 p-4 rounded-xl border-l-[4px] border-[#032650]">
            <div class="text-[#032650] font-black text-xl uppercase tracking-wider mb-1">Wo</div>
          ...
          <div class="bg-gray-50 p-4 rounded-xl border-l-[4px] border-[#032650]">
            ...
            <div class="text-lg font-medium text-gray-700">
              15 EUR für 3 Monate
              <span class="text-sm text-gray-500 font-bold block mt-1">(+ 5 EUR einmalige Aufnahmegebühr)</span>
            </div>
          </div>
          <div
            class="text-[#032650] font-black text-xl mt-6 bg-blue-100 p-4 rounded-xl text-center shadow-sm border border-blue-200">
            Einmal Schnuppern ist kostenfrei!
          </div>
        </div>

        <div class="bg-gray-50 p-5 rounded-xl border border-gray-200 mt-auto">
          <h4 class="font-bold text-[#032650] text-xl mb-3">Anmeldung & Kontakt</h4>
      ...
      <div class="w-full xl:w-1/2 sticky top-24 xl:-mt-2">
        <div class="xl:hidden">
        ...
        <div class="hidden xl:grid grid-cols-[50px_1fr] gap-4">
          <div></div>
    ...
    <div class="max-w-[1400px] mx-auto mt-20 px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        <div
          class="bg-white rounded-xl shadow-md border-t-[5px] border-blue-400 p-6 flex flex-col h-full hover:shadow-xl transition-shadow">
        ...
        <div
          class="bg-white rounded-xl shadow-md border-t-[5px] border-[#cd7f32] p-6 flex flex-col h-full hover:shadow-xl transition-shadow">
          <h3 class="font-black text-xl text-[#032650] mb-4 flex items-center gap-2">
        ...
        <div
          class="bg-white rounded-xl shadow-md border-t-[5px] border-[#c0c0c0] p-6 flex flex-col h-full hover:shadow-xl transition-shadow">
          <h3 class="font-black text-xl text-[#032650] mb-4 flex items-center gap-2">
        ...
        <div
          class="bg-white rounded-xl shadow-md border-t-[5px] border-[#ffd700] p-6 flex flex-col h-full hover:shadow-xl transition-shadow">
          <h3 class="font-black text-xl text-[#032650] mb-4 flex items-center gap-2">
